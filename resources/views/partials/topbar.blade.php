<div class="headerbar">
    ...
    <nav class="navbar-custom">
        <ul class="list-inline float-right mb-0">
                ...
                <a data-toggle="tooltip" data-placement="right" title="Ayuda" style="cursor: pointer; color: white !important; margin-right: 10px;" class="button"><i class="fas fa-question-circle"></i></a>
